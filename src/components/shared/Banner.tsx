        ...
        <section className="overflow-hidden py-16 bg-[#0c0d10]">
            <div className='relative grid grid-cols-1 md:grid-cols-2 items-center gap-10 bg-[#15171d] shadow-md rounded-3xl p-12 max-w-[1232px] mx-auto border border-[#222630]'>
                <div className="space-y-5 z-10 text-center md:text-left">
                    ...
                    <Link href='/library' className='flex inline-flex items-center justify-center gap-2 px-4 md:px-8 py-2 md:py-4 bg-[#c2f800]/90 text-[#0c0d10] text-xs font-semibold rounded-xl shadow-md backdrop-blur-sm hover:bg-[#a1cd03] transition duration-300 mx-auto md:mx-0 uppercase'>
                    Browse Workouts 
                    </Link>
                </div>
