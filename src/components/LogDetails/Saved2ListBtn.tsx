...
const SavedToListBtn = ({ log }: {log: ILog}) => {
    ...
    return (
        <div>
            <button onClick={()=> handleSaved2List()} className="btn h-9 min-h-9 border border-[#343b47] bg-transparent px-4 text-[10px] font-semibold text-white hover:border-[#596273] hover:bg-[#171b22]">
